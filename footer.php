...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info">
		<p class="footer-usjt"><a href="http://www.usjt.br" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/usjt_logo.png" alt="Universidade São Judas Tadeu"></a></p>
